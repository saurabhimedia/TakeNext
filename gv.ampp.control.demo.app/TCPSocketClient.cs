...
namespace gv.ampp.control.demo.app
{
    public class TCPSocketClient : IDisposable
    {
        ...
        private static readonly LogUtil log = LogUtil.getLogIUtilInstance();
        ...
        public async void SendIPCmdAsync(string cmd, int delayMilliseconds)
        {
        ...
        private async Task EnsureConnectedAsync()
        {
            if (client == null || !client.Connected)
            {
                ...
                {
                    this.SendIPCmdAsync(connectHandShakeComnand, 1000);
                }
            }
        }
